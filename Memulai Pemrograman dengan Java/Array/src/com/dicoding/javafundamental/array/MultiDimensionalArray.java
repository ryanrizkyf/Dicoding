...
public class MultiDimensionalArray {
    public static void main(String[] args){
        ...
        System.out.println("Dimensi 1 dengan indeks 0 dan Dimensi 2 dengan indeks 0: " + arrChar[1][0]);
        System.out.println("Dimensi 1 dengan indeks 0 dan Dimensi 2 dengan indeks 1: " + arrChar[1][1]);
