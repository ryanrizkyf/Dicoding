...
public class OperatorConditional {
    public static void main(String[] args) {
        ...
        System.out.println("Hasil Opeartor AND pada syarat value == 3 dan anotherValue == 5 adalah " + result);
        System.out.println("Hasil Opeartor AND pada syarat value != 3 dan anotherValue == 5 adalah " + anotherResult);
        System.out.println();
        ...
        System.out.println("Hasil Opeartor OR pada syarat value == 3 dan anotherValue == 5 adalah " + result);
